    ...
    return (
      <section className="hero-gradient">
        <div className="container text-center">
          <Image src="/project-voice-logo.png" id="logo" alt="Project Voice Logo" width="300" height="200" />
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 mt-5 mt-lg-0 text-center">
              <Image src="/ai_transparent.png" alt="AI Communication System" className="img-fluid hero-image" id="ai_image" width="800" height="600" />
            </div>
          </div>
        </div>
      </section>
