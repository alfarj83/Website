    ...
    return (
      <section className="hero-gradient">
        <div className="container text-center">
          <img src="/assets/project-voice-logo.png" id="logo" alt="Project Voice Logo" />
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 mt-5 mt-lg-0 text-center">
              <img src="/assets/ai_transparent.png" alt="AI Communication System" className="img-fluid hero-image" id="ai_image" />
            </div>
          </div>
        </div>
      </section>
