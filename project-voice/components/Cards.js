    ...
    return (
      <div className="auth-container">
        <div className="auth-card">
          <Image src="project-voice-logo.png" alt="Project Voice Logo" className="logo" width="400" height="200" />
          ...
          <form>
            ...
            <p className="text-center mt-4 text-muted">
              Already have an account? <a href="/login.js" className="text-primary">Log in</a>
            </p>
          </form>
        </div>
      </div>
      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <form>
            ...
            <p className="text-center mt-4 text-muted">
              Don&apos;t have an account? <a href="/sign-up.js" className="text-primary">Sign up</a>
           </p>
          </form>
        </div>
      </div>
